...
struct CreateUserHostView: View {
                    ...
                    Button("Sign Up") {
                        ...
                        Task{
                            ...
                            if (user_id != nil) {
                                ...
                                err = "An error occurred while trying to create host profile"
                                showErr = true
                            }
...
struct CreateUserHostView_Previews: PreviewProvider {
